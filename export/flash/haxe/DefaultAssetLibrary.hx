...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/bloodstain.png", __ASSET__assets_bloodstain_png);
		type.set ("assets/bloodstain.png", AssetType.IMAGE);
		className.set ("assets/car.png", __ASSET__assets_car_png);
...
@:keep @:bind #if display private #end class __ASSET__assets_bloodstain_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_car_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
//@:bitmap("assets/bloodstain.png") class __ASSET__assets_bloodstain_png extends openfl.display.BitmapData {}
//@:bitmap("assets/car.png") class __ASSET__assets_car_png extends openfl.display.BitmapData {}
